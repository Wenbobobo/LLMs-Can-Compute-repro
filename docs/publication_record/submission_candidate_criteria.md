...
Current hygiene-only control sidecars must remain explicit:
...
P72_post_p71_archive_polish_and_explicit_stop_handoff remains a hygiene-only
archive/control sidecar.

explicit stop or no further action remains the downstream recommendation.
