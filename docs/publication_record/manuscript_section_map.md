...
| Compiled boundary | Explain why the preserved first compiled step is the tiny typed-bytecode `D0` boundary inside the broader current `H43` paper endpoint and why widening was explicitly rejected. In the frozen order, the frontend boundary diagram precedes the exact-trace / final-state table. | `results/P1_paper_readiness/m6_frontend_boundary_diagram.svg`, `results/P1_paper_readiness/exact_trace_final_state_table.md`, `results/M7_frontend_candidate_decision/decision_summary.json` | main text |
