...
`F2` must remain downstream of the saved post-`H32` planning surface and the
conditional `H33` question-selection packet. It does not authorize widened
execution, scope lift, or demo narrative by itself.
