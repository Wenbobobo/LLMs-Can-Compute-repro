...
- [x] Fix bytecode ops.
- [x] Fix translator contract.
- [x] Fix differential-harness contract.
- [x] Implement verifier and lowering path.
- [x] Export the first short exact-trace / long exact-final-state harness run.
- [x] Decide the next pass: control flow first, memory typing later.
