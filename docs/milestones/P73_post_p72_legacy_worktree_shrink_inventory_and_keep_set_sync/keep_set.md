...
Preferred active and preserved branches for the current phase:
...
- dirty root quarantine:
  `wip/root-main-parking-2026-03-24`

Path policy:

- current and future active work should prefer `D:/zWenbo/AI/wt/`
- dirty root `main` at `D:/zWenbo/AI/LLMCompute` remains quarantine-only
- `D:/zWenbo/AI/LLMCompute-worktrees/` is historical local storage only
- the only default preserved legacy-path exception is `wip/r33-next`
